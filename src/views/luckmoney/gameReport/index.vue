...
import { useGameReport, reportTypeOptions } from "./utils/hook";
...
defineOptions({ name: "LuckmoneyGameReport" });
...
<template>
  <div class="main">
    ...
    >
      <el-form-item :label="$t('luckmoney.type')" prop="reportType">
        <el-select
      ...
      <el-form-item :label="$t('luckmoney.gameType')" prop="gameType">
        <el-select
      ...
      <el-form-item :label="$t('luckmoney.gameManufacturers')" prop="gameGroup">
        <el-select v-model="searchForm.gameGroup" clearable class="!w-[150px]">
          <el-option
      ...
      <el-form-item :label="$t('luckmoney.agencyAccount')" prop="agencyAccount">
        <el-input
